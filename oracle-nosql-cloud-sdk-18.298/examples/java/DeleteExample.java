...
public class DeleteExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            output("Delete Row(s) example: "
            		+ "created table, statement:\n\t" +
            ...
            MapValue value = new MapValue().
            		...
            		put("address_line1", "street1").
            		put("address_line2", "area1");
            ...
            // verify all records have been inserted
            ...
            output("Number of rows: " + results.size());
            ...
            output("Number of rows: " + results1.size());
             ...
             */
            output("Delete Row(s) example: closing handle");
            handle.close();
        }
    }
